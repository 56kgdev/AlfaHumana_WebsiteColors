    ...
    <div>    
        ...
        <div id="props-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div v-for="(n,i) in sliderInfo" :index="i" :property="n" :key="n.propertyid" :style="'background-image:url('+sliderInfo[i].largephoto+');'" class="item image-slider-contain" :class=" {'active':(i==0)}">    
...
<style>
    ...
    .carousel-shade a {
        ...
        color: #fff;
        font-weight: 900;
        border-color: #009bde86;
    
    }
    .carousel-shade a:hover{
        background-color: #003d57be !important;
        color: #fff !important; 
        font-weight: 900;
