...
<html lang="es">
  <head>
    <script>  
      ...
      function checkCookie(clave) {        
        ...
        if (cookie!="") {
          $.ajax({
            url: "https://www.immosystem.com.mx/api/countvisits.php?companyid=237&concurrent=1",
            method: "GET",
            async: false,         
            dataType: "json",
            ...
            createCookie(clave,1,365);
              $.ajax({
              url: "https://www.immosystem.com.mx/api/countvisits.php?companyid=237&unic=1",
              method: "GET",
              async: false,         
              dataType: "json",
              success: function(respuesta) {
  ...
  <body data-spy="scroll" data-offset="80" onload="checkCookie('count')" onunload="beforeExit()">
    ...
    <script language="JavaScript" type="text/javascript">
      ...
      function beforeExit() {        
        $.ajax({
          url: "https://www.immosystem.com.mx/api/countvisits.php?companyid=237&live=0",
          method: "GET",
          async: false,         
          dataType: "json",
          success: function(respuesta) {
